...
export class SearchProductsUseCase {
  ...
  execute(query: string, params?: PaginationParams, searchParams?: ProductSearchParams): Observable<PaginatedResponse<Product>> {
    return this.repository.searchProducts(query, params, searchParams);
  }
}
